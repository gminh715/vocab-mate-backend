...
interface TermData {
  ...
  examples: { sentence: string; translationVi: string }[];
}
  ...
  [
    {
      ...
      examples: [
        { sentence: 'Artificial intelligence can analyze student performance data.', translationVi: 'Trí tuệ nhân tạo có thể phân tích dữ liệu hiệu suất của học sinh.' },
        { sentence: 'Many companies invest heavily in artificial intelligence.', translationVi: 'Nhiều công ty đầu tư mạnh vào trí tuệ nhân tạo.' },
      ],
    },
    {
      value: 'transforming',
      ...
      examples: [
        { sentence: 'Technology is transforming healthcare delivery.', translationVi: 'Công nghệ đang thay đổi hoàn toàn việc cung cấp dịch vụ y tế.' },
        { sentence: 'The internet has transformed how we communicate.', translationVi: 'Internet đã thay đổi hoàn toàn cách chúng ta giao tiếp.' },
      ],
    },
    {
      value: 'classrooms',
      ...
      examples: [
        { sentence: 'Modern classrooms are equipped with interactive whiteboards.', translationVi: 'Các lớp học hiện đại được trang bị bảng trắng tương tác.' },
        { sentence: 'The classroom was silent during the exam.', translationVi: 'Lớp học im lặng trong suốt kỳ thi.' },
      ],
    },
  ],
  // Sentence 1
  [
    {
      ...
      vocabularyTopic: 'Technology',
      examples: [
        { sentence: 'Adaptive learning platforms adjust difficulty in real time.', translationVi: 'Nền tảng học thích ứng điều chỉnh độ khó theo thời gian thực.' },
        { sentence: 'The adaptive algorithm improved user engagement.', translationVi: 'Thuật toán thích ứng cải thiện sự tương tác của người dùng.' },
      ],
    },
    {
      value: 'personalizes',
      ...
      vocabularyTopic: 'Technology',
      examples: [
        { sentence: 'The app personalizes recommendations based on your history.', translationVi: 'Ứng dụng cá nhân hóa đề xuất dựa trên lịch sử của bạn.' },
        { sentence: 'Schools aim to personalize education for every child.', translationVi: 'Các trường học hướng tới cá nhân hóa giáo dục cho mỗi trẻ.' },
      ],
    },
    {
      value: 'weaknesses',
      ...
      examples: [
        { sentence: 'The test revealed her weaknesses in grammar.', translationVi: 'Bài kiểm tra cho thấy điểm yếu của cô ấy về ngữ pháp.' },
        { sentence: 'Knowing your weaknesses is the first step to improvement.', translationVi: 'Biết điểm yếu của bạn là bước đầu tiên để cải thiện.' },
      ],
    },
  ],
  // Sentence 2
  [
    {
      ...
      examples: [
        { sentence: 'Over-reliance on GPS can reduce navigational skills.', translationVi: 'Phụ thuộc quá mức vào GPS có thể làm giảm kỹ năng định hướng.' },
        { sentence: 'The report warned against over-reliance on a single supplier.', translationVi: 'Báo cáo cảnh báo về sự phụ thuộc quá mức vào một nhà cung cấp duy nhất.' },
      ],
    },
    {
      value: 'undermine',
      ...
      vocabularyTopic: 'Critical Thinking',
      examples: [
        { sentence: 'Constant criticism can undermine a child\'s self-esteem.', translationVi: 'Chỉ trích liên tục có thể làm suy yếu lòng tự trọng của trẻ.' },
        { sentence: 'The scandal undermined public trust in the institution.', translationVi: 'Vụ bê bối đã làm suy yếu niềm tin của công chúng vào tổ chức.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Education',
      examples: [
        { sentence: 'Universities aim to develop students\' critical thinking.', translationVi: 'Các trường đại học hướng tới phát triển tư duy phản biện của sinh viên.' },
        { sentence: 'Critical thinking helps people evaluate information objectively.', translationVi: 'Tư duy phản biện giúp mọi người đánh giá thông tin một cách khách quan.' },
      ],
    },
  ],
  // Sentence 3
  [
    {
      ...
      vocabularyTopic: 'Education',
      examples: [
        { sentence: 'Blended learning became popular during the pandemic.', translationVi: 'Học tập kết hợp trở nên phổ biến trong đại dịch.' },
        { sentence: 'The school adopted a blended learning approach last year.', translationVi: 'Trường đã áp dụng phương pháp học tập kết hợp vào năm ngoái.' },
      ],
    },
    {
      value: 'face-to-face',
      ...
      examples: [
        { sentence: 'Face-to-face instruction allows immediate feedback.', translationVi: 'Giảng dạy trực tiếp cho phép phản hồi ngay lập tức.' },
        { sentence: 'Many employees prefer face-to-face meetings over video calls.', translationVi: 'Nhiều nhân viên thích cuộc họp trực tiếp hơn cuộc gọi video.' },
      ],
    },
    {
      value: 'yields',
      ...
      examples: [
        { sentence: 'The experiment yielded unexpected results.', translationVi: 'Thí nghiệm mang lại kết quả bất ngờ.' },
        { sentence: 'Careful planning yields better outcomes.', translationVi: 'Lập kế hoạch cẩn thận mang lại kết quả tốt hơn.' },
      ],
    },
  ],
  // Sentence 4
  [
    {
      ...
      vocabularyTopic: 'Change & Development',
      examples: [
        { sentence: 'Languages evolve over centuries.', translationVi: 'Ngôn ngữ phát triển qua nhiều thế kỷ.' },
        { sentence: 'The company\'s strategy has evolved significantly.', translationVi: 'Chiến lược của công ty đã phát triển đáng kể.' },
      ],
    },
    {
      value: 'guidelines',
      ...
      examples: [
        { sentence: 'The government issued new health guidelines.', translationVi: 'Chính phủ ban hành hướng dẫn y tế mới.' },
        { sentence: 'Please read the safety guidelines before starting.', translationVi: 'Vui lòng đọc hướng dẫn an toàn trước khi bắt đầu.' },
      ],
    },
    {
      value: 'equitable',
      ...
      examples: [
        { sentence: 'The policy aims to ensure equitable access to education.', translationVi: 'Chính sách nhằm đảm bảo tiếp cận giáo dục công bằng.' },
        { sentence: 'An equitable solution benefits all parties.', translationVi: 'Giải pháp công bằng mang lại lợi ích cho tất cả các bên.' },
      ],
    },
  ],
];
  ...
  [
    {
      ...
      examples: [
        { sentence: 'The rover transmitted high-resolution images of the Martian surface.', translationVi: 'Xe tự hành truyền hình ảnh độ phân giải cao về bề mặt sao Hỏa.' },
        { sentence: 'Engineers designed the rover to withstand extreme temperatures.', translationVi: 'Các kỹ sư thiết kế xe tự hành để chịu được nhiệt độ khắc nghiệt.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'The lawyer presented a compelling case to the jury.', translationVi: 'Luật sư trình bày một vụ việc thuyết phục trước bồi thẩm đoàn.' },
        { sentence: 'Her story was so compelling that everyone listened in silence.', translationVi: 'Câu chuyện của cô ấy hấp dẫn đến mức mọi người im lặng lắng nghe.' },
      ],
    },
    {
      ...
      examples: [
        { sentence: 'Microbial life can survive in extreme environments.', translationVi: 'Sự sống vi sinh vật có thể tồn tại trong môi trường khắc nghiệt.' },
        { sentence: 'The soil sample showed signs of microbial activity.', translationVi: 'Mẫu đất cho thấy dấu hiệu hoạt động vi sinh vật.' },
      ],
    },
  ],
  [
    {
      ...
      examples: [
        { sentence: 'The lab analyzed blood samples from the patients.', translationVi: 'Phòng thí nghiệm phân tích mẫu máu từ bệnh nhân.' },
        { sentence: 'Water samples were collected from the river.', translationVi: 'Mẫu nước được thu thập từ sông.' },
      ],
    },
    {
      ...
      examples: [
        { sentence: 'Organic molecules are the building blocks of life.', translationVi: 'Phân tử hữu cơ là nền tảng của sự sống.' },
        { sentence: 'The telescope detected organic molecules in the distant galaxy.', translationVi: 'Kính viễn vọng phát hiện phân tử hữu cơ trong thiên hà xa xôi.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Science',
      examples: [
        { sentence: 'Biological research has led to many medical breakthroughs.', translationVi: 'Nghiên cứu sinh học đã dẫn đến nhiều đột phá y học.' },
        { sentence: 'The biological clock regulates our sleep patterns.', translationVi: 'Đồng hồ sinh học điều chỉnh chu kỳ giấc ngủ của chúng ta.' },
      ],
    },
  ],
  [
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'Doctors caution against excessive screen time.', translationVi: 'Bác sĩ cảnh báo về thời gian sử dụng màn hình quá mức.' },
        { sentence: 'He cautioned his team to verify every detail.', translationVi: 'Anh ấy cảnh báo nhóm xác minh mọi chi tiết.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'Doctors ruled out cancer after the tests.', translationVi: 'Bác sĩ loại trừ ung thư sau các xét nghiệm.' },
        { sentence: 'We cannot rule out a technical malfunction.', translationVi: 'Chúng ta không thể loại trừ lỗi kỹ thuật.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'The findings were published in a leading journal.', translationVi: 'Các phát hiện được công bố trên tạp chí hàng đầu.' },
        { sentence: 'Our findings suggest a link between diet and health.', translationVi: 'Phát hiện của chúng tôi cho thấy mối liên hệ giữa chế độ ăn và sức khỏe.' },
      ],
    },
  ],
  [
    {
      ...
      examples: [
        { sentence: 'The cleanup was a joint effort by the community.', translationVi: 'Việc dọn dẹp là nỗ lực chung của cộng đồng.' },
        { sentence: 'The project succeeded through a joint effort of three departments.', translationVi: 'Dự án thành công nhờ nỗ lực chung của ba phòng ban.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Science',
      examples: [
        { sentence: 'The museum displayed rare fossil specimens.', translationVi: 'Bảo tàng trưng bày mẫu hóa thạch quý hiếm.' },
        { sentence: 'Specimens must be stored at the correct temperature.', translationVi: 'Mẫu vật phải được bảo quản ở nhiệt độ chính xác.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Space Exploration',
      examples: [
        { sentence: 'The mission to the International Space Station lasted six months.', translationVi: 'Sứ mệnh tới Trạm Vũ trụ Quốc tế kéo dài sáu tháng.' },
        { sentence: 'The rescue mission saved all survivors.', translationVi: 'Sứ mệnh cứu hộ đã cứu tất cả những người sống sót.' },
      ],
    },
  ],
  [
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'The results were confirmed by an independent laboratory.', translationVi: 'Kết quả đã được xác nhận bởi phòng thí nghiệm độc lập.' },
        { sentence: 'Please confirm your attendance by Friday.', translationVi: 'Vui lòng xác nhận sự tham gia trước thứ Sáu.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Academic',
      examples: [
        { sentence: 'The internet has fundamentally changed communication.', translationVi: 'Internet đã thay đổi căn bản cách giao tiếp.' },
        { sentence: 'Their approaches are fundamentally different.', translationVi: 'Phương pháp của họ khác nhau căn bản.' },
      ],
    },
    {
      ...
      vocabularyTopic: 'Change & Development',
      examples: [
        { sentence: 'Climate change could alter weather patterns worldwide.', translationVi: 'Biến đổi khí hậu có thể thay đổi các mô hình thời tiết trên toàn thế giới.' },
        { sentence: 'The new evidence altered the investigation\'s direction.', translationVi: 'Bằng chứng mới đã thay đổi hướng điều tra.' },
      ],
    },
  ],
];
...
const sleepTerms: TermData[][] = [
  [
    { value: 'study', wordDisplay: 'study', lemma: 'study', normalizedLemma: 'study', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈstʌd.i/', cefrLevel: 'A2', contextualMeaningVi: 'nghiên cứu', definitionEn: 'A detailed investigation of a subject.', contextualExplanation: 'Refers to a scientific research project on sleep and health.', synonyms: ['research', 'investigation'], antonyms: [], collocations: ['conduct a study', 'a recent study'], relatedTerms: ['research', 'survey', 'experiment'], vocabularyTopic: 'Science', examples: [{ sentence: 'A study found that reading improves memory.', translationVi: 'Một nghiên cứu phát hiện rằng đọc sách cải thiện trí nhớ.' }, { sentence: 'The study involved 1,000 participants.', translationVi: 'Nghiên cứu có sự tham gia của 1.000 người.' }] },
    { value: 'mental health', wordDisplay: 'mental health', lemma: 'mental health', normalizedLemma: 'mental health', unitType: 'PHRASE', partOfSpeech: 'noun', ipa: '/ˈmen.təl helθ/', cefrLevel: 'A2', contextualMeaningVi: 'sức khỏe tinh thần', definitionEn: 'A person\'s psychological and emotional well-being.', contextualExplanation: 'The article focuses on how sleep affects psychological health.', synonyms: ['psychological health', 'emotional well-being'], antonyms: [], collocations: ['mental health awareness', 'mental health support'], relatedTerms: ['well-being', 'psychology', 'stress'], vocabularyTopic: 'Health', examples: [{ sentence: 'Schools are investing more in mental health programs.', translationVi: 'Các trường đang đầu tư nhiều hơn vào chương trình sức khỏe tinh thần.' }, { sentence: 'Exercise is good for both physical and mental health.', translationVi: 'Tập thể dục tốt cho cả sức khỏe thể chất và tinh thần.' }] },
    { value: 'enough', wordDisplay: 'enough', lemma: 'enough', normalizedLemma: 'enough', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/ɪˈnʌf/', cefrLevel: 'A1', contextualMeaningVi: 'đủ', definitionEn: 'As much as is necessary.', contextualExplanation: 'Getting sufficient sleep — usually 7 to 9 hours for adults.', synonyms: ['sufficient', 'adequate'], antonyms: ['insufficient', 'inadequate'], collocations: ['enough time', 'enough sleep'], relatedTerms: ['sufficient', 'plenty', 'ample'], vocabularyTopic: 'Daily Life', examples: [{ sentence: 'Do you get enough sleep every night?', translationVi: 'Bạn có ngủ đủ giấc mỗi đêm không?' }, { sentence: 'There was not enough food for everyone.', translationVi: 'Không có đủ thức ăn cho mọi người.' }] },
  ],
  [
    { value: 'stressed', wordDisplay: 'stressed', lemma: 'stressed', normalizedLemma: 'stressed', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/strest/', cefrLevel: 'A2', contextualMeaningVi: 'căng thẳng', definitionEn: 'Feeling worried and unable to relax.', contextualExplanation: 'Lack of sleep causes people to feel tense and overwhelmed.', synonyms: ['tense', 'overwhelmed'], antonyms: ['relaxed', 'calm'], collocations: ['feel stressed', 'stressed out'], relatedTerms: ['stress', 'anxiety', 'pressure'], vocabularyTopic: 'Health', examples: [{ sentence: 'She felt stressed about the upcoming exam.', translationVi: 'Cô ấy cảm thấy căng thẳng về kỳ thi sắp tới.' }, { sentence: 'Too much work makes people stressed.', translationVi: 'Quá nhiều công việc khiến mọi người căng thẳng.' }] },
    { value: 'anxious', wordDisplay: 'anxious', lemma: 'anxious', normalizedLemma: 'anxious', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/ˈæŋk.ʃəs/', cefrLevel: 'B1', contextualMeaningVi: 'lo lắng', definitionEn: 'Feeling worried or nervous about something.', contextualExplanation: 'Sleep deprivation increases feelings of anxiety.', synonyms: ['worried', 'nervous'], antonyms: ['calm', 'confident'], collocations: ['feel anxious', 'anxious about'], relatedTerms: ['anxiety', 'worry', 'nervousness'], vocabularyTopic: 'Health', examples: [{ sentence: 'He felt anxious before the job interview.', translationVi: 'Anh ấy cảm thấy lo lắng trước buổi phỏng vấn.' }, { sentence: 'Children can feel anxious about starting a new school.', translationVi: 'Trẻ em có thể cảm thấy lo lắng khi bắt đầu trường mới.' }] },
    { value: 'less than', wordDisplay: 'less than', lemma: 'less than', normalizedLemma: 'less than', unitType: 'PHRASE', partOfSpeech: 'adverb', ipa: '/les ðæn/', cefrLevel: 'A2', contextualMeaningVi: 'ít hơn', definitionEn: 'A smaller amount compared to something.', contextualExplanation: 'Quantifies the insufficient amount of sleep (under six hours).', synonyms: ['fewer than', 'under'], antonyms: ['more than', 'over'], collocations: ['less than expected', 'less than average'], relatedTerms: ['fewer', 'under', 'below'], vocabularyTopic: 'Quantity', examples: [{ sentence: 'Less than 50% of students passed the test.', translationVi: 'Ít hơn 50% học sinh đạt bài kiểm tra.' }, { sentence: 'The trip takes less than an hour.', translationVi: 'Chuyến đi mất ít hơn một giờ.' }] },
  ],
  [
    { value: 'recommend', wordDisplay: 'recommend', lemma: 'recommend', normalizedLemma: 'recommend', unitType: 'WORD', partOfSpeech: 'verb', ipa: '/ˌrek.əˈmend/', cefrLevel: 'A2', contextualMeaningVi: 'khuyên, đề nghị', definitionEn: 'To suggest something as a good course of action.', contextualExplanation: 'Doctors give professional advice about sleep habits.', synonyms: ['suggest', 'advise'], antonyms: ['discourage', 'oppose'], collocations: ['highly recommend', 'recommend that'], relatedTerms: ['suggestion', 'advice', 'counsel'], vocabularyTopic: 'Health', examples: [{ sentence: 'I recommend this book to all students.', translationVi: 'Tôi khuyên cuốn sách này cho tất cả học sinh.' }, { sentence: 'Experts recommend drinking eight glasses of water daily.', translationVi: 'Chuyên gia khuyên uống tám cốc nước mỗi ngày.' }] },
    { value: 'electronic devices', wordDisplay: 'electronic devices', lemma: 'electronic device', normalizedLemma: 'electronic device', unitType: 'PHRASE', partOfSpeech: 'noun', ipa: '/ɪˌlek.ˈtrɒn.ɪk dɪˈvaɪsɪz/', cefrLevel: 'A2', contextualMeaningVi: 'thiết bị điện tử', definitionEn: 'Machines that use electrical circuits, such as phones and computers.', contextualExplanation: 'Phones, tablets, and computers that emit blue light and disrupt sleep.', synonyms: ['gadgets', 'electronics'], antonyms: [], collocations: ['use electronic devices', 'turn off electronic devices'], relatedTerms: ['smartphone', 'tablet', 'screen time'], vocabularyTopic: 'Technology', examples: [{ sentence: 'Children spend too much time on electronic devices.', translationVi: 'Trẻ em dành quá nhiều thời gian trên thiết bị điện tử.' }, { sentence: 'Please turn off all electronic devices during the flight.', translationVi: 'Vui lòng tắt tất cả thiết bị điện tử trong chuyến bay.' }] },
    { value: 'bedtime', wordDisplay: 'bedtime', lemma: 'bedtime', normalizedLemma: 'bedtime', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈbed.taɪm/', cefrLevel: 'A2', contextualMeaningVi: 'giờ đi ngủ', definitionEn: 'The usual time when someone goes to bed.', contextualExplanation: 'The period before sleeping when screen use should be avoided.', synonyms: ['sleeping time'], antonyms: ['wake-up time'], collocations: ['before bedtime', 'bedtime routine'], relatedTerms: ['sleep', 'night', 'rest'], vocabularyTopic: 'Daily Life', examples: [{ sentence: 'Reading before bedtime helps you relax.', translationVi: 'Đọc sách trước giờ ngủ giúp bạn thư giãn.' }, { sentence: 'My bedtime is usually 10 PM.', translationVi: 'Giờ đi ngủ của tôi thường là 10 giờ tối.' }] },
  ],
  [
    { value: 'regular', wordDisplay: 'regular', lemma: 'regular', normalizedLemma: 'regular', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/ˈreɡ.jə.lɚ/', cefrLevel: 'A2', contextualMeaningVi: 'thường xuyên, đều đặn', definitionEn: 'Done or happening frequently.', contextualExplanation: 'Exercising on a consistent basis helps improve sleep quality.', synonyms: ['frequent', 'routine'], antonyms: ['irregular', 'occasional'], collocations: ['regular exercise', 'on a regular basis'], relatedTerms: ['routine', 'habit', 'consistent'], vocabularyTopic: 'Health', examples: [{ sentence: 'Regular exercise reduces the risk of heart disease.', translationVi: 'Tập thể dục đều đặn giảm nguy cơ bệnh tim.' }, { sentence: 'She has regular check-ups with her doctor.', translationVi: 'Cô ấy khám sức khỏe định kỳ với bác sĩ.' }] },
    { value: 'consistent', wordDisplay: 'consistent', lemma: 'consistent', normalizedLemma: 'consistent', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/kənˈsɪs.tənt/', cefrLevel: 'B1', contextualMeaningVi: 'nhất quán, đều đặn', definitionEn: 'Always behaving in the same way; unchanging.', contextualExplanation: 'A fixed sleep schedule that doesn\'t change from day to day.', synonyms: ['steady', 'uniform'], antonyms: ['inconsistent', 'erratic'], collocations: ['consistent with', 'consistent results'], relatedTerms: ['consistency', 'stable', 'reliable'], vocabularyTopic: 'Personal Development', examples: [{ sentence: 'Consistent effort leads to success.', translationVi: 'Nỗ lực nhất quán dẫn đến thành công.' }, { sentence: 'Her performance has been consistent throughout the year.', translationVi: 'Hiệu suất của cô ấy nhất quán suốt cả năm.' }] },
    { value: 'fall asleep', wordDisplay: 'fall asleep', lemma: 'fall asleep', normalizedLemma: 'fall asleep', unitType: 'PHRASE', partOfSpeech: 'verb', ipa: '/fɔːl əˈsliːp/', cefrLevel: 'A2', contextualMeaningVi: 'ngủ thiếp đi', definitionEn: 'To begin to sleep.', contextualExplanation: 'The goal is to fall asleep more quickly at night.', synonyms: ['doze off', 'drift off'], antonyms: ['wake up', 'stay awake'], collocations: ['fall asleep quickly', 'struggle to fall asleep'], relatedTerms: ['sleep', 'nap', 'doze'], vocabularyTopic: 'Daily Life', examples: [{ sentence: 'I usually fall asleep within ten minutes.', translationVi: 'Tôi thường ngủ thiếp đi trong vòng mười phút.' }, { sentence: 'The baby fell asleep in her mother\'s arms.', translationVi: 'Em bé ngủ thiếp đi trong vòng tay mẹ.' }] },
  ],
  [
    { value: 'trouble', wordDisplay: 'trouble', lemma: 'trouble', normalizedLemma: 'trouble', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈtrʌb.əl/', cefrLevel: 'A2', contextualMeaningVi: 'khó khăn, vấn đề', definitionEn: 'Difficulty or problems.', contextualExplanation: 'Having difficulty falling or staying asleep.', synonyms: ['difficulty', 'problem'], antonyms: ['ease', 'comfort'], collocations: ['have trouble', 'cause trouble'], relatedTerms: ['problem', 'issue', 'difficulty'], vocabularyTopic: 'Daily Life', examples: [{ sentence: 'He had trouble understanding the instructions.', translationVi: 'Anh ấy gặp khó khăn khi hiểu hướng dẫn.' }, { sentence: 'If you have any trouble, ask for help.', translationVi: 'Nếu bạn gặp bất kỳ khó khăn nào, hãy nhờ giúp đỡ.' }] },
    { value: 'should', wordDisplay: 'should', lemma: 'should', normalizedLemma: 'should', unitType: 'WORD', partOfSpeech: 'verb', ipa: '/ʃʊd/', cefrLevel: 'A1', contextualMeaningVi: 'nên', definitionEn: 'Used to give advice or make a recommendation.', contextualExplanation: 'Giving advice: it is important to consult a medical professional.', synonyms: ['ought to', 'had better'], antonyms: ['should not'], collocations: ['you should', 'should try'], relatedTerms: ['must', 'ought', 'need'], vocabularyTopic: 'Communication', examples: [{ sentence: 'You should eat more vegetables.', translationVi: 'Bạn nên ăn nhiều rau hơn.' }, { sentence: 'Students should review their notes daily.', translationVi: 'Học sinh nên ôn bài hàng ngày.' }] },
    { value: 'more than', wordDisplay: 'more than', lemma: 'more than', normalizedLemma: 'more than', unitType: 'PHRASE', partOfSpeech: 'adverb', ipa: '/mɔːr ðæn/', cefrLevel: 'A1', contextualMeaningVi: 'nhiều hơn', definitionEn: 'A greater amount compared to something.', contextualExplanation: 'Lasting longer than two weeks is a sign to seek medical help.', synonyms: ['over', 'above'], antonyms: ['less than', 'under'], collocations: ['more than enough', 'more than expected'], relatedTerms: ['greater', 'above', 'exceeding'], vocabularyTopic: 'Quantity', examples: [{ sentence: 'More than 80% of participants agreed.', translationVi: 'Hơn 80% người tham gia đồng ý.' }, { sentence: 'The event attracted more than 500 people.', translationVi: 'Sự kiện thu hút hơn 500 người.' }] },
  ],
];
...
const remoteTerms: TermData[][] = [
  [
    { value: 'permanent', wordDisplay: 'permanent', lemma: 'permanent', normalizedLemma: 'permanent', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/ˈpɜːr.mə.nənt/', cefrLevel: 'B1', contextualMeaningVi: 'vĩnh viễn, cố định', definitionEn: 'Lasting or intended to last indefinitely.', contextualExplanation: 'Remote work is no longer temporary — it has become a lasting part of how businesses operate.', synonyms: ['lasting', 'enduring'], antonyms: ['temporary', 'short-term'], collocations: ['permanent position', 'permanent change'], relatedTerms: ['persistent', 'fixed', 'stable'], vocabularyTopic: 'Business', examples: [{ sentence: 'She was offered a permanent contract.', translationVi: 'Cô ấy được đề nghị hợp đồng dài hạn.' }, { sentence: 'The damage to the building was permanent.', translationVi: 'Thiệt hại cho tòa nhà là vĩnh viễn.' }] },
    { value: 'workplace', wordDisplay: 'workplace', lemma: 'workplace', normalizedLemma: 'workplace', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈwɜːrk.pleɪs/', cefrLevel: 'B1', contextualMeaningVi: 'nơi làm việc', definitionEn: 'A place where people work, such as an office.', contextualExplanation: 'The concept of the workplace now includes home offices and co-working spaces.', synonyms: ['office', 'work environment'], antonyms: [], collocations: ['modern workplace', 'workplace culture'], relatedTerms: ['office', 'company', 'work'], vocabularyTopic: 'Business', examples: [{ sentence: 'Safety in the workplace is a top priority.', translationVi: 'An toàn tại nơi làm việc là ưu tiên hàng đầu.' }, { sentence: 'The workplace has changed dramatically since the pandemic.', translationVi: 'Nơi làm việc đã thay đổi đáng kể kể từ đại dịch.' }] },
    { value: 'hybrid', wordDisplay: 'hybrid', lemma: 'hybrid', normalizedLemma: 'hybrid', unitType: 'WORD', partOfSpeech: 'adjective', ipa: '/ˈhaɪ.brɪd/', cefrLevel: 'B2', contextualMeaningVi: 'kết hợp, lai', definitionEn: 'Combining two different elements.', contextualExplanation: 'A work model that mixes in-office and remote working days.', synonyms: ['mixed', 'blended'], antonyms: ['pure', 'uniform'], collocations: ['hybrid model', 'hybrid work'], relatedTerms: ['combination', 'mixed', 'blend'], vocabularyTopic: 'Business', examples: [{ sentence: 'Many companies now offer hybrid work schedules.', translationVi: 'Nhiều công ty hiện cung cấp lịch làm việc kết hợp.' }, { sentence: 'The hybrid car uses both electric and petrol engines.', translationVi: 'Xe hybrid sử dụng cả động cơ điện và xăng.' }] },
  ],
  [
    { value: 'employees', wordDisplay: 'employees', lemma: 'employee', normalizedLemma: 'employee', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ɪmˈplɔɪ.iːz/', cefrLevel: 'A2', contextualMeaningVi: 'nhân viên', definitionEn: 'People who are hired to work for a company.', contextualExplanation: 'Workers who benefit from flexible remote work arrangements.', synonyms: ['workers', 'staff'], antonyms: ['employers'], collocations: ['company employees', 'full-time employees'], relatedTerms: ['employer', 'worker', 'staff'], vocabularyTopic: 'Business', examples: [{ sentence: 'The company has over 500 employees.', translationVi: 'Công ty có hơn 500 nhân viên.' }, { sentence: 'Employees are entitled to annual leave.', translationVi: 'Nhân viên được quyền nghỉ phép hàng năm.' }] },
    { value: 'productivity', wordDisplay: 'productivity', lemma: 'productivity', normalizedLemma: 'productivity', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˌprɒd.ʌkˈtɪv.ə.t̬i/', cefrLevel: 'B2', contextualMeaningVi: 'năng suất', definitionEn: 'The rate at which goods or work is produced.', contextualExplanation: 'Employees working from home get more done according to surveys.', synonyms: ['efficiency', 'output'], antonyms: ['inefficiency'], collocations: ['increase productivity', 'productivity levels'], relatedTerms: ['efficiency', 'performance', 'output'], vocabularyTopic: 'Business', examples: [{ sentence: 'New tools increased the team\'s productivity by 20%.', translationVi: 'Công cụ mới tăng năng suất nhóm lên 20%.' }, { sentence: 'Productivity tends to drop when people are stressed.', translationVi: 'Năng suất có xu hướng giảm khi mọi người căng thẳng.' }] },
    { value: 'choose', wordDisplay: 'choose', lemma: 'choose', normalizedLemma: 'choose', unitType: 'WORD', partOfSpeech: 'verb', ipa: '/tʃuːz/', cefrLevel: 'A1', contextualMeaningVi: 'chọn', definitionEn: 'To pick out from a number of options.', contextualExplanation: 'Having the freedom to select work location and hours.', synonyms: ['select', 'pick'], antonyms: ['reject'], collocations: ['choose to', 'choose between'], relatedTerms: ['choice', 'option', 'decision'], vocabularyTopic: 'Daily Life', examples: [{ sentence: 'You can choose any color you like.', translationVi: 'Bạn có thể chọn bất kỳ màu nào bạn thích.' }, { sentence: 'She chose to study abroad.', translationVi: 'Cô ấy chọn du học.' }] },
  ],
  [
    { value: 'challenges', wordDisplay: 'challenges', lemma: 'challenge', normalizedLemma: 'challenge', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈtʃæl.ɪn.dʒɪz/', cefrLevel: 'B1', contextualMeaningVi: 'thách thức', definitionEn: 'Difficult tasks or problems that test abilities.', contextualExplanation: 'The difficulties managers face when leading remote teams.', synonyms: ['difficulties', 'obstacles'], antonyms: ['opportunities'], collocations: ['face challenges', 'overcome challenges'], relatedTerms: ['obstacle', 'difficulty', 'hurdle'], vocabularyTopic: 'Business', examples: [{ sentence: 'Every business faces unique challenges.', translationVi: 'Mỗi doanh nghiệp đối mặt với thách thức riêng.' }, { sentence: 'Climate change presents significant challenges.', translationVi: 'Biến đổi khí hậu đặt ra những thách thức đáng kể.' }] },
    { value: 'cohesion', wordDisplay: 'cohesion', lemma: 'cohesion', normalizedLemma: 'cohesion', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/koʊˈhiː.ʒən/', cefrLevel: 'C1', contextualMeaningVi: 'sự gắn kết', definitionEn: 'The act of forming a united whole; togetherness.', contextualExplanation: 'Keeping team members connected and working well together when they are physically apart.', synonyms: ['unity', 'solidarity'], antonyms: ['division', 'fragmentation'], collocations: ['team cohesion', 'social cohesion'], relatedTerms: ['unity', 'bonding', 'togetherness'], vocabularyTopic: 'Business', examples: [{ sentence: 'Team-building activities improve group cohesion.', translationVi: 'Hoạt động xây dựng nhóm cải thiện sự gắn kết.' }, { sentence: 'Social cohesion is important for a stable society.', translationVi: 'Sự gắn kết xã hội quan trọng cho xã hội ổn định.' }] },
    { value: 'company culture', wordDisplay: 'company culture', lemma: 'company culture', normalizedLemma: 'company culture', unitType: 'PHRASE', partOfSpeech: 'noun', ipa: '/ˈkʌm.pə.ni ˈkʌl.tʃɚ/', cefrLevel: 'B2', contextualMeaningVi: 'văn hóa công ty', definitionEn: 'The shared values, behaviors, and practices within an organization.', contextualExplanation: 'The identity and atmosphere of a company that can be harder to maintain remotely.', synonyms: ['corporate culture', 'organizational culture'], antonyms: [], collocations: ['build company culture', 'strong company culture'], relatedTerms: ['work environment', 'values', 'ethos'], vocabularyTopic: 'Business', examples: [{ sentence: 'A positive company culture attracts talented employees.', translationVi: 'Văn hóa công ty tích cực thu hút nhân viên tài năng.' }, { sentence: 'Remote work has reshaped company culture worldwide.', translationVi: 'Làm việc từ xa đã định hình lại văn hóa công ty trên toàn thế giới.' }] },
  ],
  [
    { value: 'collaboration', wordDisplay: 'collaboration', lemma: 'collaboration', normalizedLemma: 'collaboration', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/kəˌlæb.əˈreɪ.ʃən/', cefrLevel: 'B2', contextualMeaningVi: 'sự cộng tác', definitionEn: 'The action of working with someone to produce something.', contextualExplanation: 'Working together across distances using digital tools.', synonyms: ['cooperation', 'teamwork'], antonyms: ['competition'], collocations: ['close collaboration', 'international collaboration'], relatedTerms: ['cooperate', 'partner', 'teamwork'], vocabularyTopic: 'Business', examples: [{ sentence: 'The project required collaboration between multiple teams.', translationVi: 'Dự án yêu cầu sự cộng tác giữa nhiều nhóm.' }, { sentence: 'Online tools facilitate real-time collaboration.', translationVi: 'Công cụ trực tuyến hỗ trợ cộng tác thời gian thực.' }] },
    { value: 'time zones', wordDisplay: 'time zones', lemma: 'time zone', normalizedLemma: 'time zone', unitType: 'PHRASE', partOfSpeech: 'noun', ipa: '/taɪm zoʊnz/', cefrLevel: 'B1', contextualMeaningVi: 'múi giờ', definitionEn: 'Regions of the globe that have the same standard time.', contextualExplanation: 'Teams working in different parts of the world with different local times.', synonyms: [], antonyms: [], collocations: ['across time zones', 'different time zones'], relatedTerms: ['UTC', 'local time', 'schedule'], vocabularyTopic: 'Geography', examples: [{ sentence: 'Scheduling meetings across time zones can be tricky.', translationVi: 'Lên lịch họp qua các múi giờ có thể khó khăn.' }, { sentence: 'The US spans several time zones.', translationVi: 'Hoa Kỳ trải dài qua nhiều múi giờ.' }] },
    { value: 'platforms', wordDisplay: 'platforms', lemma: 'platform', normalizedLemma: 'platform', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ˈplæt.fɔːrmz/', cefrLevel: 'B1', contextualMeaningVi: 'nền tảng', definitionEn: 'Software systems that provide a base for other applications or services.', contextualExplanation: 'Digital tools like Zoom, Slack, and Asana that enable remote work.', synonyms: ['systems', 'services'], antonyms: [], collocations: ['digital platforms', 'technology platforms'], relatedTerms: ['software', 'application', 'tool'], vocabularyTopic: 'Technology', examples: [{ sentence: 'Social media platforms connect billions of people.', translationVi: 'Các nền tảng mạng xã hội kết nối hàng tỷ người.' }, { sentence: 'The company built its own e-commerce platform.', translationVi: 'Công ty xây dựng nền tảng thương mại điện tử riêng.' }] },
  ],
  [
    { value: 'predict', wordDisplay: 'predict', lemma: 'predict', normalizedLemma: 'predict', unitType: 'WORD', partOfSpeech: 'verb', ipa: '/prɪˈdɪkt/', cefrLevel: 'B1', contextualMeaningVi: 'dự đoán', definitionEn: 'To say what you think will happen in the future.', contextualExplanation: 'Experts are forecasting future workplace trends.', synonyms: ['forecast', 'anticipate'], antonyms: [], collocations: ['predict the future', 'experts predict'], relatedTerms: ['prediction', 'forecast', 'anticipation'], vocabularyTopic: 'Business', examples: [{ sentence: 'Analysts predict strong economic growth this year.', translationVi: 'Các nhà phân tích dự đoán tăng trưởng kinh tế mạnh mẽ năm nay.' }, { sentence: 'It is difficult to predict the weather accurately.', translationVi: 'Rất khó dự đoán thời tiết chính xác.' }] },
    { value: 'arrangements', wordDisplay: 'arrangements', lemma: 'arrangement', normalizedLemma: 'arrangement', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/əˈreɪndʒ.mənts/', cefrLevel: 'B1', contextualMeaningVi: 'sự sắp xếp', definitionEn: 'Plans or preparations for a future event or situation.', contextualExplanation: 'The different ways companies structure work schedules and locations.', synonyms: ['plans', 'setups'], antonyms: [], collocations: ['work arrangements', 'flexible arrangements'], relatedTerms: ['plan', 'schedule', 'setup'], vocabularyTopic: 'Business', examples: [{ sentence: 'We need to make travel arrangements for the conference.', translationVi: 'Chúng ta cần sắp xếp đi lại cho hội nghị.' }, { sentence: 'Flexible work arrangements benefit both employers and employees.', translationVi: 'Sắp xếp công việc linh hoạt có lợi cho cả chủ và nhân viên.' }] },
    { value: 'exception', wordDisplay: 'exception', lemma: 'exception', normalizedLemma: 'exception', unitType: 'WORD', partOfSpeech: 'noun', ipa: '/ɪkˈsep.ʃən/', cefrLevel: 'B1', contextualMeaningVi: 'ngoại lệ', definitionEn: 'Something that is not included in a general rule.', contextualExplanation: 'Remote work will no longer be unusual — it will be normal.', synonyms: ['anomaly', 'deviation'], antonyms: ['rule', 'norm'], collocations: ['with the exception of', 'no exception'], relatedTerms: ['unusual', 'special case', 'outlier'], vocabularyTopic: 'Language', examples: [{ sentence: 'Every student must attend, with no exception.', translationVi: 'Mọi học sinh phải tham dự, không có ngoại lệ.' }, { sentence: 'This rule applies to everyone without exception.', translationVi: 'Quy tắc này áp dụng cho tất cả mọi người không có ngoại lệ.' }] },
  ],
];
